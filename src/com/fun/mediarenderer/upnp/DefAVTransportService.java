...
public class DefAVTransportService extends AbstractAVTransportService {
	...
	final private static String TAG = "DefAVTransportService";
    ...
    protected Map<UnsignedIntegerFourBytes, DefMediaPlayer> getPlayers() {
        return players;
    }
    
    protected DefMediaPlayer getInstance(UnsignedIntegerFourBytes instanceId) throws AVTransportException {
    	DefMediaPlayer player = getPlayers().get(instanceId);
    	log.finer("player getInstance");
        if (player == null) {
        	log.finer("player is null");
	...
	public TransportInfo getTransportInfo(
			@UpnpInputArgument(name = "InstanceID") UnsignedIntegerFourBytes arg0)
			throws AVTransportException {
		Log.d(TAG,"getTransportInfo called");
	...
	public void seek(
		...
		final DefMediaPlayer player = getInstance(arg0);
        SeekMode seekMode;
        try {
